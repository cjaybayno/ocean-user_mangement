...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2 id="header-title">Consolidation</h2>
				...
				<div class="form-horizontal">
					...
					<div class="form-group">
						<div class="col-md-3 col-sm-3 col-xs-12">
							<input type="text" name="date_range" id="date_range" class="form-control col-md-7 col-xs-12" readonly style="cursor:pointer;" title="click to select date">
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-3 col-sm-3 col-xs-12">
					...
					<br>
					<table id="conso-loan-table"  class="table table-striped responsive-utilities jambo_table" cellspacing="0" width="100%" style="display:none">
						<thead>
							 <tr class="headings">
								<th>Member Name</th>
								<th>Total Release</th>
