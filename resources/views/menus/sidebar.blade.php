...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
	<div class="menu_section">
		...
		<ul class="nav side-menu">
			...
			<li><a><i class="fa fa-credit-card"></i>Application<span class="fa fa-chevron-down"></span></a>
				<ul class="nav child_menu" style="display: none">
			...
			<li><a><i class="fa fa-cubes"></i> Consolidation <span class="fa fa-chevron-down"></span></a>
				<ul class="nav child_menu" style="display: none">
	...
	<div class="menu_section">
		...
		<ul class="nav side-menu">
			<li><a href="{{ URL::route('users') }}"><i class="fa fa-user"></i>Users</span></a></li>
			<li><a href="{{ URL::route('user.groups') }}"><i class="fa fa-users"></i><span>Groups</span></a></li>
